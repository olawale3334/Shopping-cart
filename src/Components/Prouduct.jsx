...
const Prouduct = ({product}) => {
  ...
  return (
    <div className='mt-10 px-4 '>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4  md:justify-center lg:justify-center z-10 '>
            {product.map((product)=>(
                <div className=' mb-5' >
                    <div className='md:w-[19rem]  relative  group transition bg-white   rounded-xl px-6 py-4  '>
            <div className=''>
            ...
            <div className=' absolute  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  hidden group-hover:block z-20 '>
                <button className='flex bg-black items-center text-[0.80rem] gap-2 hover:bg-blue-400 text-white py-2 px-6 '>
                    ADD TO CART
